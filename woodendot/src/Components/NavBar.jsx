...
const NavBar = () => {
    ...
    return (
        <>
            <div className={"relative w-full h-[70px] bg-white py-6 border-b-[1px] m-auto px-4"}>
                <div className={"max-w-[1440px] flex m-auto justify-between items-center"}>
                    ...
                    <div className={nav ? "text-white z-20 sm:text-black" : "text-black"}>
                    ...
                    <div
                        className={nav ? "overflow-hidden sm:hidden ease-in duration-500 absolute w-full top-0 left-0 " +
                            "h-screen bg-black/90 flex px-4 py-7 text-white z-10"
                            : "absolute top-0 h-screen left-[-100%] ease-in duration-500 text-white z-10"}>
